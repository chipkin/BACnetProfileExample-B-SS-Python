...
For the **BACnet B-SS (Smart Sensor) Python example** -
...
> `CHANGE ALL OF THIS BEFORE YOU SHIP` block at the top of `main.py`. The
...
| **Product Name** | CAS BACnet Stack Example - B-SS (Python) |
